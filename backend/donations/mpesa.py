...
class MpesaService:
    ...
    def get_access_token(self):
        ...
        try:
            ...
            logger.error("mpesa_token_error", error=str(e))
            raise
    ...
    def initiate_stk_push(self, phone, amount, account_reference, transaction_desc=None):
        ...
        try:
            ...
            logger.info("mpesa_stk_push_initiated", amount=amount, phone=phone)
            ...
            logger.error("mpesa_stk_push_error", error=str(e))
            raise
    ...
    def query_status(self, checkout_request_id):
        ...
        try:
            ...
            logger.error("mpesa_query_error", checkout_request_id=checkout_request_id, error=str(e))
            raise
